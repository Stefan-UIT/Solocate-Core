...
struct AppColor {
    ...
    static let greenColor            = UIColor(hex: "#4CD493")
    static let redColor          = UIColor(hex: "#FF4444")
    static let deliveryStatus            = greenColor
...
//    static let pickedUpStatus       = UIColor(hex: "#28D467")
    ...
    static let normal               = UIColor(hex: "#485D70")
