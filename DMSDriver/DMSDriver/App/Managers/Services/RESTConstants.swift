...
//    case UPDATE_STATUS_TASK = "backend-api/v1/tasks/%@/%@"
    ...
    case GET_DRIVER_LIST  = "masterdata/v1/drivers/list-suggest?route_id=%@&start_time=%@&end_time=%@&company_id=%@"
    case GET_TRUCK_LIST  = "masterdata/v1/trucks/list-active?truck_type_id=%@"
