...
class PickerInputView: BaseViewController {
    ...
    override func updateUI() {
        DispatchQueue.main.async {[weak self] in
            ...
            case .PickerInputTextView:
                self?.conHeightViewContent?.constant = 220
...
extension PickerInputView{
    ...
    class func showInputViewWith(type :PickerInputViewType,
        ...
        let vc:PickerInputView = PickerInputView.loadSB(SB: .Common)
        ...
        nv.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        atVC.present(nv, animated: true, completion: nil)
    }
