  ...
  var orderDetailItem: OrderDetailInforRow! {
    didSet {
        ...
        if orderDetailItem.type == .address ||
            orderDetailItem.type == .phone ||
            orderDetailItem.type == .coordinationPhone ||
            orderDetailItem.type == .collectCall{
            contentLabel?.textColor = AppColor.mainColor
            
        }else{
            contentLabel?.textColor = AppColor.black
        }
    }
  }
...
struct OrderDetailInforRow {
  ...
  var content: String = ""
    ...
    init(_ type: OrderDetailType, _ content:String) {
        ...
        case .apartment:
            name = "Apartment".localized
        case .floor:
            name = "Floor".localized
        case .entrance:
            name = "Entrance".localized
        case .taskId:
            name = "Task Id".localized
        }
    }
}
